  ...
  listener: (context, state) {
    ...
    if(state is SignUpLoaded){
      ...
      if(state.signUpModel.token.isNotEmpty){
        showSnackBar(context, 'Success', Colors.green, Icons.check, 'Account successfully created');
                      ...
                      LoginButton(
                        ...
                        onTap: () {
                          if(formKey.currentState!.validate()){
                            BlocProvider.of<SignUpBloc>(context).add(OnSignUp(fName: firstNameController.text, lName: lastNameController.text, email: emailController.text, phone: phoneController.text, password: passController.text, confirm: confirmPassController.text));
                          }
                        },
                      ),
                      SizedBox(
